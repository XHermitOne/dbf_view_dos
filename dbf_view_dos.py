...
DOSBOX_CMD_FMT = 'dosbox -c \"mount C: %s\" -c \"mount D: /usr/share/dbf_view_dos\" -c \"D:\\rk.com\" -c "D:\\%s %s" %s &'
...
def main(*argv):
    ...
    if dbf_filename and os.path.exists(dbf_filename):
        ...
        if viewer_option:
            ...
            cmd = DOSBOX_CMD_FMT % (home_path, viewer_option, dos_dbf_filename, exit_option)
